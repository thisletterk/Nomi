...
export const onboarding = [
  {
    ID: 1,
    title: "Brittany Burgunder",
    description: "Not all battles are visible and neither are the victories.",
    backgroundColor: "#e5ead7",
    image: images.screen2,
  },
  {
    ID: 2,
    title: "Your mental health is just as important as your physical health.",
    description:
  ...
  },
  {
    ID: 5,
    title: "Shonda Rhimes",
    description: "Your struggles do not define you.",
